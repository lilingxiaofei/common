...
public class ClearEditText extends EditText implements View.OnFocusChangeListener, View.OnTouchListener,
        TextWatcher {
    ...
    private void init(Context context) {
        ...
        if(mClearTextIcon == null){
            final Drawable drawable = ContextCompat.getDrawable(context, R.mipmap.icon_delete_two);
