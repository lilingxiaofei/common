...
public class ClearEditTextTwo extends EditText implements TextWatcher,
    ...
    public ClearEditTextTwo(Context context) {
        this(context, null);
    }

    public ClearEditTextTwo(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public ClearEditTextTwo(Context context, AttributeSet attrs, int defStyle) {
